...
namespace FiordilotoMVC.Controllers
{
    public class UsersAdminController : Controller
    {
        ...
        public async Task<ActionResult> Edit([Bind(Include = "Id,Email,UserName")] EditUserViewModel editUser, params string[] selectedRole)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult FotoResize(int? id)
        {
            return View();
        }
    }
