...
namespace FiordilotoMVC.Controllers
{
    public class IntroController : Controller
    {
        ...
        private const string SlidePath = "/Content/Immagini/Intro";

        private readonly string[] _imageFileExtensions = { ".jpg", ".png", ".gif", ".jpeg" };

        [HttpGet]
        public ActionResult UploadIntro(int? id)
        {
            ViewBag.Eid = id;
            return View();
        }
        ...
        [HttpGet]
        public ActionResult _UploadIntro(int? id)
        {
            return PartialView();
        }

        [ValidateAntiForgeryToken]
        public ActionResult _UploadIntro(IEnumerable<HttpPostedFileBase> files)
        {
        ...
        [HttpPost]
        public ActionResult Save(string t, string l, string h, string w, string fileName, int eid)
        {
            try
            {
        ...
        private static string SaveTemporaryAvatarFileImage(HttpPostedFileBase file, string serverPath, string fileName)
        {
            ...
            img.Resize(SlideScreenWidth, (int)(SlideScreenWidth * ratio));
